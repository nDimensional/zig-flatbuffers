...
#define __MyGame_Sample_Monster_formal_args ,\
  ...
  flatbuffers_uint8_vec_ref_t v5, MyGame_Sample_Color_enum_t v6, MyGame_Sample_Weapon_vec_ref_t v7, MyGame_Sample_Equipment_union_ref_t v9, MyGame_Sample_Vec3_vec_ref_t v10
...
__flatbuffers_build_vector_field(10, flatbuffers_, MyGame_Sample_Monster_path, MyGame_Sample_Vec3, MyGame_Sample_Vec3_t, MyGame_Sample_Monster)
...
static inline MyGame_Sample_Monster_ref_t MyGame_Sample_Monster_create(flatbuffers_builder_t *B __MyGame_Sample_Monster_formal_args)
{
    if (MyGame_Sample_Monster_start(B)
        ...
        || MyGame_Sample_Monster_path_add(B, v10)
...
static MyGame_Sample_Monster_ref_t MyGame_Sample_Monster_clone(flatbuffers_builder_t *B, MyGame_Sample_Monster_table_t t)
{
    ...
    if (MyGame_Sample_Monster_start(B)
        ...
        || MyGame_Sample_Monster_path_pick(B, t)
